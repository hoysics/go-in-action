...
import (
	...
	"github.com/hoysics/go-in-action/orm/insert/internal/errs"
	valuer2 "github.com/hoysics/go-in-action/orm/insert/internal/valuer"
...
// goos: linux
// goarch: amd64
// pkg: github.com/hoysics/go-in-action/orm
...
// PASS
// ok      github.com/hoysics/go-in-action/orm     16.324s
func BenchmarkQuerier_Get(b *testing.B) {
	...
	b.Run("unsafe", func(b *testing.B) {
		db.valCreator = valuer2.NewUnsafeValue
		for i := 0; i < b.N; i++ {
